...
while opcao_menu_inicio != 2:
    ...
    if opcao_menu_inicio == 1:
        ...
        escala = int(
            input(
                f"{chatbot}: Em uma escala de 0 a 5, sendo 0 totalmente insatisfeito,\n "
        ...
        if escala == 0:
            ...
            print(
                f"{chatbot}: Muito obrigado, que pena :( "
            ...
            print(f"Você digitou {escala}\n")
            print(
                f"{chatbot}: Muito obrigado, espero que na proxima compra possamos melhor lhe atender\n"
            )
