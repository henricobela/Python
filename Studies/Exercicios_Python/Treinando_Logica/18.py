...
print(f"Para um arquivo de tamanho: {tamanho_arq} MB, com uma velocidade de internet de: {velocidade_link} Mbps, o tempo medio para download é de: {tempo_medio:.2f} minutos")
