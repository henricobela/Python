...
if metros_area > metros_lata_18_litros:
    ...
    print(f"A quantidade de galoes de tinta será: {qntd_galao} e o preco total a ser pago é: R$ {galao_valor * qntd_galao}")
else:
    print(f"A quantidade de latas de tinta será: {qntd_latas + 1} e o preco total a ser pago é: R$ {valor_lata}!!!")
    print(f"A quantidade de galoes de tinta será: {qntd_galao + 1} e o preco total a ser pago é: R$ {galao_valor * qntd_galao}")